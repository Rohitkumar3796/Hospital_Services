...
# Both classes will create his own primary key automatically but we have to give foreign key as state to city table 

# Create your models here.
class State(models.Model):
    name = models.CharField(max_length = 50, null = False, blank = False)
    # this dunder method is used for object name that is given on admin of state objects(this is important)
    def __str__(self):
        return self.name
